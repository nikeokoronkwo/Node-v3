...
This repo has two branches: This branch uses a full typescript implementation. For the same js implementation with declaration types see the jsdoc branch.
