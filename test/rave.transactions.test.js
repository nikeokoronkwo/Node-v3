...
describe('#Rave Transactions', function () {
  ...
  it('should successfully verify a payment', async function () {
    ...
    const verifyTransactionStub = sinon.stub(trxInstance, 'verify').resolves({
      status: 'success',
  ...
  it('should successfully return transaction events', async function () {
    ...
    const getTransactionEventStub = sinon.stub(trxInstance, 'event').resolves({
      status: 'success',
  ...
  it('should successfully return transaction fee', async function () {
    ...
    const getTransactionFeeStub = sinon.stub(trxInstance, 'fee').resolves({
      status: 'success',
      message: 'Charged fee',
      data: {
        charge_amount: 1000,
